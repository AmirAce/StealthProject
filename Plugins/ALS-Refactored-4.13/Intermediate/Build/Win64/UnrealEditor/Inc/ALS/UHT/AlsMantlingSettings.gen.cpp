...
template<> ALS_API UScriptStruct* StaticStruct<FAlsGeneralMantlingSettings>()
{
	...
	struct Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::ScriptStructInfo[] = {
		...
		{ FAlsGeneralMantlingSettings::StaticStruct, Z_Construct_UScriptStruct_FAlsGeneralMantlingSettings_Statics::NewStructOps, TEXT("AlsGeneralMantlingSettings"), &Z_Registration_Info_UScriptStruct_AlsGeneralMantlingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAlsGeneralMantlingSettings), 1934343858U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAlsMantlingSettings, UAlsMantlingSettings::StaticClass, TEXT("UAlsMantlingSettings"), &Z_Registration_Info_UClass_UAlsMantlingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAlsMantlingSettings), 3967928563U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_1729136636(TEXT("/Script/ALS"),
		Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsMantlingSettings_h_Statics::EnumInfo));
