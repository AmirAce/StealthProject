...
template<> ALS_API UScriptStruct* StaticStruct<FAlsInAirSettings>()
{
	...
	struct Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsInAirSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsInAirSettings_h_Statics::ScriptStructInfo[] = {
		{ FAlsInAirSettings::StaticStruct, Z_Construct_UScriptStruct_FAlsInAirSettings_Statics::NewStructOps, TEXT("AlsInAirSettings"), &Z_Registration_Info_UScriptStruct_AlsInAirSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAlsInAirSettings), 3873671459U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsInAirSettings_h_1515321004(TEXT("/Script/ALS"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsInAirSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StealthProject_Plugins_ALS_Refactored_4_13_Source_ALS_Public_Settings_AlsInAirSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
